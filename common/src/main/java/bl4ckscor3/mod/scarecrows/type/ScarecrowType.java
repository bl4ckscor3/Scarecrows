...
public abstract class ScarecrowType {
	...
	public final boolean hasArms(LevelAccessor level, BlockPos pos, Direction pumpkinFacing) {
		...
		if ((pumpkinFacing == Direction.EAST || pumpkinFacing == Direction.WEST) &&
				stateNorth.is(Scarecrows.ARM.get()) && stateNorth.getValue(ArmBlock.FACING) == Direction.NORTH &&
				stateSouth.is(Scarecrows.ARM.get()) && stateSouth.getValue(ArmBlock.FACING) == Direction.SOUTH &&
				stateWest.isAir() && stateEast.isAir()) {
			return true;
		}
		else if ((pumpkinFacing == Direction.NORTH || pumpkinFacing == Direction.SOUTH) &&
				stateEast.is(Scarecrows.ARM.get()) && stateEast.getValue(ArmBlock.FACING) == Direction.EAST &&
				stateWest.is(Scarecrows.ARM.get()) && stateWest.getValue(ArmBlock.FACING) == Direction.WEST &&
